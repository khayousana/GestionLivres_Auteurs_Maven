...
public class UserDaoImlp implements UserDao {
	...
	public List<User> findAll() {
		EntityManagerFactory emf = Persistence.createEntityManagerFactory("Atelier_JPA");
	...
	public User login(User user) {
		...
		try {
			...
			User u = manager.createQuery("SELECT user FROM User user WHERE user.login = :login",
					User.class)
